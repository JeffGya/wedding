<template>
  ...
  <section class="hero mt-[12rem] text-center mb-32">
    <div class="mb-4 items-center">
      <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 928.06 899.01" class="w-24 h-24 md:w-32 md:h-32 fill-[var(--int-base)]">
    ...
    <h1
      class="font-cursive w-full text-[var(--int-base)] m-0 mb-8
        text-5xl
        md:text-5xl md:px-4 md:py-4 text-shadow-sm
        lg:text-[5rem]
        "
    >
      Brigita & Jeffrey
  ...
  <div class="container mx-auto px-16 md:px-24 lg:px-80">
    <WeddingCountdown />
