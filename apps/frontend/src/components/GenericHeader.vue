<template>
    <div id="logo" class="flex items-center space-x-4 justify-center md:block md:space-y-2 my-16
    ">
      <router-link :to="{ name: 'home', params: { lang: $route.params.lang || 'en' } }">
      ...
      <span class="space-y-1">
        <p class="text-xl font-cursive text-center mt-2 mb-0 text-int-base tracking-wide">Brigita & Jeffrey</p>
        <p class="text-sm font-serif text-center mt-1 mb-8 text-int-base tracking-wide">01-08-2024</p>
      </span>
    </div>
